<h1 align="center">
  <strong><a href="https://bithabib.github.io/flash_ssd_simulator_web/templates/flash_memory.html">Eyana: The SSD Simulator</a></strong>
</h1>
# Abstract 
...
In our simulator, we have focused on incorporating channel-level parallelism as a key aspect of Flash SSD technology. Channel-level parallelism enables efficient communication between the flash controller and the flash packages, as it allows simultaneous and independent access to multiple channels. These individual channels are shared among multiple packages, optimizing data transfer and enhancing overall SSD performance. By simulating this specific type of parallelism, our simulator provides valuable insights into how Flash SSDs leverage channel-level parallelism to improve data processing capabilities and achieve higher levels of efficiency.
